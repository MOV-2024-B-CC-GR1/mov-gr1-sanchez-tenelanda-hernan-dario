...
fun main(args: Array<String>) {
    ...
    val inmutable: String = "Hernan";
    // inmutable = "Dario" // Error!
    // MUTABLES
    var mutable: String = "Dario"
    mutable = "Hernna" // Ok
    // VAL > VAR


    // Duck Typing
    val ejemploVariable = " Hernan Dario "
    ejemploVariable.trim()
    val edadEjemplo: Int = 12
    // ejemploVariable = edadEjemplo // Error!
    // Variables Primitivas
    val nombreProfesor: String = "Hernan Dario"
    ...
    // Named parameters calcularSueldo(sueldo, tasa, bonoEspecial)
